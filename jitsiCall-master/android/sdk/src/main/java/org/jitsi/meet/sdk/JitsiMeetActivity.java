...
//        JitsiMeetOngoingConferenceService.abort(this);
    ...
    protected void onResume() {
        ...
        intentFilter.addAction("org.jitsi.meet.BEGIN_SHARE_ROOM");
        intentFilter.addAction("BEGIN_SHARE_ROOM");
        intentFilter.addAction("CALL_HANGUP");
    ...
    public class mCallHangup extends BroadcastReceiver {
        ...
        @Override
        public void onReceive(Context context, Intent intent) {
//            onShareUrl(intent.getStringExtra("roomUrl"));

            Log.e("CALL_HANGUP from Fugu", intent.getAction());

            if (intent.getAction().equalsIgnoreCase("org.jitsi.meet.BEGIN_SHARE_ROOM")) {
                onShareUrl(intent.getStringExtra("roomUrl"));
            } else {
                leave();
            }
...
//        JitsiMeetOngoingConferenceService.launch(this);
    ...
    protected void onShareUrl(String url) {
        try {
            Intent mIntent = new Intent("URL SHARED");
            mIntent.putExtra("roomUrl", url);
            LocalBroadcastManager.getInstance(this).sendBroadcast(mIntent);

            JitsiMeetLogger.i("Share url: ", url);
        } catch (Exception e) {
